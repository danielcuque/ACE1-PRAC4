...
mEvaluatePrompt macro
    ...
    mCompareCommand DIVIDIRCommand
    cmp DL, 00
    jne exeDiv
	...
	mCompareCommand YLOGICOCommand
	cmp DL,00
	jne exeYlogic

	mCompareCommand OXLOGICOCommand
	cmp DL,00
	jne exeOxlogic

	mCompareCommand NOLOGICOCommand
	cmp DL,00
	jne exeNologic
...
mMul macro
  LOCAL start, isAsteriskArg1, isNumberArg1, isCellArg1, isAsteriskArg2, isNumberArg2, isCellArg2, evaluateArg2, errorArgs, success, endMul
 push AX
 push BX
 push DI
...
mDiv macro
 LOCAL start, isAsteriskArg1, isNumberArg1, isCellArg1, isAsteriskArg2, isNumberArg2, isCellArg2, evaluateArg2, errorArgs, success, endDiv
 push AX
 push BX
 push DI
...
;; La división es AX / BX
 ...
 evaluateArg2:
    ...
    mCompareCommand ENTRECommand                ;; Comparamos que esté el comando Y
    cmp DL, 00
    je errorArgs

    add SI, 05h                             ;; Avanzamos el espacio
...
mOLogic macro 
    LOCAL start, isAsteriskArg1, isNumberArg1, isCellArg1, isAsteriskArg2, isNumberArg2, isCellArg2, evaluateArg2, errorArgs, success, endOLogic
    push AX
    push BX
    push DI
    ...
    jne isCellArg1
    jmp errorArgs
    ;; En el O lógico vamos a realizar un OR a nivel de bits
    isAsteriskArg1:
        mov DI, offset returnValue              ;; Obtenemos el valor del valor de retorno
        mov BX, [DI]                            
        mov [guardarParametroNumero], BX        ;; Aquí guardamos el valor de A
...
mYLogic macro 
    LOCAL start, isAsteriskArg1, isNumberArg1, isCellArg1, isAsteriskArg2, isNumberArg2, isCellArg2, evaluateArg2, errorArgs, success, endYLogic
    push AX
    push BX
    push DI
...
mOXLogic macro 
    LOCAL start, isAsteriskArg1, isNumberArg1, isCellArg1, isAsteriskArg2, isNumberArg2, isCellArg2, evaluateArg2, errorArgs, success, endOXLogic
    push AX
    push BX
    push DI
...
mNoLogic macro 
    LOCAL start, isAsteriskArg1, isNumberArg1, isCellArg1, isAsteriskArg2, isNumberArg2, isCellArg2, evaluateArg2, errorArgs, success, endNoLogic
    push AX
    push BX
    push DI
    ...
    isNumberArg1:
        mov BX, [numberGotten]                  ;; Si es un numero, entonces obtenemos el numero que se generó
        mov [guardarParametroNumero], BX        ;; y lo guardamos en el parametro A
        jmp success                       ;; Saltamos a evaluar B
...
mProcessCell macro
    ...
    start:
        ...
        proccesPosition:
            ...
            mNumberForCell                ;; Preguntamos si la celda es un número
...
mNumberForCell macro
    LOCAL start1, createNumber2, success2, endOfBuffer2, isNot2, end2, generateNumber2
    push AX
    push BX
    push CX
    push DI
    ...
    success2:
        ...
        cmp CX, 07h                         ;; Si el número es mayor a 5, significa que no es válido
        jl generateNumber2                   ;; Si es menor a 5, entonces recuperamos el número
